...
int main(int argc, char *argv[]) {
  ...
  if (argc >= 3)
    inc2_threads = atoi(argv[2]);
  if (argc >= 4)
    loops = atoi(argv[3]);
  if (inc2_threads > total_threads)
    inc2_threads = total_threads;
